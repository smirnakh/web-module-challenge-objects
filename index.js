...
*/
console.log(createMenuItem('passta', 15, 'Lunch'));
console.log(createMenuItem('sushi', 25, 'Lunch'));
console.log(createMenuItem('pancake', 7, 'breakfast'));
...
function addReview(array, name, rating, feedback){
  array[index].addReview = addReview;
  return array[index];
}
